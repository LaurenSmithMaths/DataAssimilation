...
% Many realisations of a Barabasi-Albert network
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
SWITCH_TOP = 4; % network topology, 4 = Barabasi-Albert
...
%%
if (SWITCH_LOC == true)
    save("KM_DA_BA_0.7_observed_loc.mat");
else
    save("KM_DA_BA_0.7_observed_no_loc.mat");
end
...
% See the end of the ER realisations file