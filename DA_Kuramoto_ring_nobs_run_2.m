...
%%
end_rms_phi(rr,rr2) = rms_phi(end);
end_rms_omega(rr,rr2) = rms_omega(end);
...
%%
if (SWITCH_LOC == 1)
    save('DA_KM_ring_nobs_loc_2.mat')
else
    save('DA_KM_ring_nobs_no_loc_2.mat')
end
